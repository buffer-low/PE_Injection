...
int main(int argc, char * argv[]) {
	...
	DWORD bits = *(DWORD*)((char*)data + pFileDosHeader->e_lfanew + sizeof(IMAGE_FILE_HEADER));
	if (bits == 0x10b) {
		...
		WriteFile(newFile, &injectNTHeader, sizeof(IMAGE_NT_HEADERS), &numberOfByteToRead, NULL);
