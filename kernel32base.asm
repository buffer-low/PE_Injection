...
main_code:
	...
	mov eax, [eax + 0ch]		
	mov eax, [eax + 14h]		
	mov eax, [eax] ; ntdll.dll program ldr_data_table_entry
	mov eax, [eax] ; kernel32.dll base ldr_data_table_entry
	...
	push eax
	call ebx
	; find entry point to jump to using teb
	mov eax, fs:[30h]
	mov eax, [eax + 0ch]		
	mov eax, [eax + 14h]
	mov eax, [eax + 10h] ; image base
